      ...
      <div className="mx-auto grid max-w-7xl gap-6 px-5 pb-28 md:grid-cols-2 md:px-8">
        {projects.map((p, i) => (
          <Reveal key={p.name} delay={(i % 2) * 0.08}>
            <article className="group flex h-full flex-col rounded-2xl border border-white/10 bg-[#0a0e15] p-8 transition-colors duration-300 hover:border-white/20 md:p-9">
